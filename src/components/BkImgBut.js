...
function BkImgBut() {
    return (
      <div className={"nature-image"}>
        <p className="text-white font-bold transform translate-y-60 translate-x-60 text-2xl">
          TRENDS
        </p>
        <p className="text-white transform translate-y-60 translate-x-30 text-5xl">
